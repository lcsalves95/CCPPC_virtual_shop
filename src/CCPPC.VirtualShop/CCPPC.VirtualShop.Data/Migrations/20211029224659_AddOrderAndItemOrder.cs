...
{
    public partial class AddOrderAndItemOrder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: new DateTime(2021, 10, 29, 19, 46, 57, 836, DateTimeKind.Local).AddTicks(9081))
                },
                constraints: table =>
                {
